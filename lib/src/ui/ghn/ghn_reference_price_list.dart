...
class GhnReferencePriceList extends StatefulWidget {
  @override
  _GhnReferencePriceListState createState() =>
      _GhnReferencePriceListState();
}

class _GhnReferencePriceListState
    extends State<GhnReferencePriceList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("GHN - Bảng giá tham khảo"),
        ),
        body: DataTable(
